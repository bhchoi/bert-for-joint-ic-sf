...
def get_dataloader(config, preprocessor):
    train_dataset = JointDataset(os.path.join(config.data_path, "train"), preprocessor)
    val_dataset = JointDataset(os.path.join(config.data_path, "dev"), preprocessor)
    test_dataset = JointDataset(os.path.join(config.data_path, "test"), preprocessor)
